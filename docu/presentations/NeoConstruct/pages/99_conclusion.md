...
Linux and WSL<sup>1</sup>

<Footnotes x='r' seperator>
  <Footnote :number=1><i>Windows Subsystem for Linux: not tested yet</i></Footnote>
</Footnotes>

Gazebo (*no Mujoco*)

Pinocchio Auto-Complete

Steep Learning Curve

<!------- icons ------->
<img v-click="1" class="absolute right-6em top-4em" src="/Tux.svg" width="100em"/>
<img v-click="2" v-mark="{ at: '2', type: 'crossed-off', color: 'red'}" class="absolute right-4em top-15em" src="/TechStack/MuJoCo.png" width="200em"/>
<img v-click="3" class="absolute right-8em bottom-4em" src="/intellisense.png" width="300em"/>
